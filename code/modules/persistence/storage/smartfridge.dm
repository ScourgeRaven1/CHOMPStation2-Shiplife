...
/datum/persistent/storage/smartfridge/sheet_storage/lossy
	...
	min_retained = 80 //CHOMPedit: Altering how many items can be held between rounds.
	max_retained = 80 //CHOMPedit: Altering how many items can be held between rounds.
